        ...
        buttons: {
            ...
            elements: {
                ...
                'button-primary': {
                    ...
                    hideDna: true,
                    hideCode: true,
                    component: require('appdir/toolkit/buttons/ButtonPrimary').default,
                    readme: require('appdir/toolkit/buttons/ButtonPrimary/readme').default,
                },
                'button-secondary': {
                    type: 'atom',
                    ...
                    hideDna: true,
                    hideCode: true,
                    component: require('appdir/toolkit/buttons/ButtonSecondary').default,
                    readme: require('appdir/toolkit/buttons/ButtonSecondary/readme').default,
                },
                'button-tertiary': {
                    type: 'atom',
                    ...
                    hideDna: true,
                    hideCode: true,
                    component: require('appdir/toolkit/buttons/ButtonTertiary').default,
                    readme: require('appdir/toolkit/buttons/ButtonTertiary/readme').default,
                },
                'button-state': {
                    type: 'atom',
                    label: 'Button States',
        ...
        form: {
            ...
            elements: {
                ...
                checkbox: {
                    ...
                    hideCode: true,
                    component: require('appdir/toolkit/form/CompCheckbox').default,
                    readme: require('appdir/toolkit/form/CompCheckbox/readme').default,
                },
                radio: {
                    type: 'catalyst',
                    label: 'Radio',
                    ...
                    readme: require('appdir/toolkit/form/CompRadio/readme').default,
                },
            },
        },
        components: {
            ...
            elements: {
                'splash-screen': {
                    type: 'organism',
                    label: 'Splash Screen',
                    route: '/toolkit/components/splash-screen',
                    dna: '/toolkit/components/SplashScreen',
                    component: require('appdir/toolkit/components/SplashScreen').default,
                    hideDna: true,
                    hideDocs: true,
                },
            },
        ...
        icons: {
            ...
            elements: {
                'linear-icons': {
                    ...
                    component: require('appdir/toolkit/icons/LinearIcons').default,
                    readme: require('appdir/toolkit/icons/LinearIcons/readme').default,
                },
            },
        },
    },
